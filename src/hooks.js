...
export const useExportExcel = ()=>{
    ...
    const fetchCardsForUpload = async({type, date, reasons, solutions, employees, list})=>{
        ...
        if(type === "Неактивка"){
            ...
            const {data: cards} = await axiosApi.get("/cards/repeated_calls?page_size=10000000");
    ...
    return {loadingExport, fetchCardsForUpload};
}