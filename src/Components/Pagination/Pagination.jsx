...
const Pagination = ({list, setCurrentPage, currentPage, setItemsPerPage, itemsPerPage})=>{
    ...
    return(
        ...
        >
            ...
            <Grid>
                {(currentPage - 1) * itemsPerPage + 1} - {currentPage * itemsPerPage > list.length ?
            ...
            <Grid>
                ...
                <Button disabled={(currentPage - 1) * itemsPerPage + itemsPerPage > list.length} onClick={()=> {
