...
import {selectEmployees, selectUser} from "../../features/user/userSlice";
...
const Employees = ()=>{
    ...
    const handleChangeSearchEmployees = (e)=>{
        ...
        if(!value){
            ...
            setFilteredEmployees(employees.filter((item) => item.full_name.toLowerCase().includes(value.toLowerCase())));
        }
    };
