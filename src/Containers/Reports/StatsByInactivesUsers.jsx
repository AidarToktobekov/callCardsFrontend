    ...
    if (!value) {
      ...
      if (name === "employees") {
        setSearchFields(prev => (
          {
            ...prev,
            [name]: employees.filter((item) => item.full_name.toLowerCase().includes(value.toLowerCase()),)
          }
        ));
        ...
        setSearchFields(prev => (
          {
            ...prev,
            [name]: reasons.filter((item) => item.title.toLowerCase().includes(value.toLowerCase()),)
          }
        ));
        ...
        setSearchFields(prev => (
          {
            ...prev,
            [name]: solutions.filter((item) => item.title.toLowerCase().includes(value.toLowerCase()),)
          }
        ));
      }
    }
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {hovered.type === "employees" ? employeesLoading ? (
                  <CircularProgress/>
                ) : <Grid
                  sx={{
                ...
                : null}
              {hovered.type === "reason" ? reasonsLoading ? (
                <CircularProgress/>
              ) : <Grid
                sx={{
                  bgcolor: 'background.paper'
              ...
              {hovered.type === "solution" ? solutionLoading ? (
                  <CircularProgress/>
                ) : <Grid
                  sx={{
                    bgcolor: 'background.paper'
