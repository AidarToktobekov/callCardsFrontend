...
export const getReasonsList = createAsyncThunk(
  'reasonsAndSolutions/getReasons',
  async () => {
    try {
...
export const getSolutionsList = createAsyncThunk(
  'reasonsAndSolutions/getSolutions',
  async () => {
    try {
...
export const createReason = createAsyncThunk(
  'reasonsAndSolutions/createReason',
  async (reasonMutation, { rejectWithValue }) => {
    try {
      const { data: reason } = await axiosApi.post(
...
export const createSolution = createAsyncThunk(
  'reasonsAndSolutions/createSolution',
  async (solutionMutation, { rejectWithValue }) => {
    try {
      const { data: solution } = await axiosApi.post(
...
export const deleteReason = createAsyncThunk(
  'reasonsAndSolutions/deleteReason',
  async (id, { rejectWithValue }) => {
    try {
      const { data: reason } = await axiosApi.delete(
...
export const deleteSolution = createAsyncThunk(
  'reasonsAndSolutions/deleteSolution',
  async (id, { rejectWithValue }) => {
    try {
      const { data: solution } = await axiosApi.delete(
